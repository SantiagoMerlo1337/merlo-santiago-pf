...
const PortfolioButton = () => {
  ...
  return (
    <Link onMouseOver={handleText} onMouseOut={handleText} className="flex flex-col w-full md:w-1/2 mx-auto py-8 rounded text-black hover:text-tertiary-500 transition duration-100 background-pattern1" href="/portafolio">
