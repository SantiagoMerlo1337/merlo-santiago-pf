        ...
        return (
            <div className="rounded-lg shadow-lg">
                ...
                <div className="flex justify-center items-center gap-5 py-4">
                    <a href={props.site} target="_blank" className="flex text-white bg-blue-700 hover:bg-blue-600 px-2 py-1 rounded-full gap-2">
                        <Image
                    ...
                    <a href={props.github} target="_blank" className="flex text-white bg-purple-700 hover:bg-purple-600 px-2 py-1 rounded-full gap-2">
                        <Image
                        className="invert object-contain"
                        src={imgGithub}
                        alt="Icono Github"
